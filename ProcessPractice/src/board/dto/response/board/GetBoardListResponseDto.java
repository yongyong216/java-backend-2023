...
public class GetBoardListResponseDto {
	...
	public GetBoardListResponseDto(int boardNumber, String writerProfileImgeUrl, String writerNickname,
	...
	public String toString() {
		return "GetBoardListResponseDto [boardNumber=" + boardNumber + ", writerProfileImgeUrl=" + writerProfileImgeUrl
