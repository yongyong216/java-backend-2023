...
public class DateTime {
	...
	public static void main(String[] args) {
		...
		Date minusTowHour = Date.from(Instant.now().minus(2,ChronoUnit.HOURS));
		System.out.println(minusTowHour);  // 현재시간 보다 2시간 전 시간을 출력한다.
		
		// SimpleDateFormat
		// Date 타입의 참조변수를 지정한 포멧의 문자열로 변경해주는 클래스
		// y: 연, M: 월, d: 일, H: 시간, m: 분, s: 초
		SimpleDateFormat simpleDateFormat = 
				new SimpleDateFormat("yyyy.MM.dd. HH:mm:ss"); //sdp(simpleDateFormat)약어
